<?php namespace App\Http\Controllers;
	...
	class AdminBarangUploadController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			// $this->index_button[] = ["label"=>"Kosongkan Data","icon"=>"fa fa-trash","url"=>route('reset-data')];
	    ...
	    */
		...
		public function getIndex() {
			//First, Add an auth
			 ...
			 $data['result'] = DB::table('barang_upload')->paginate(100);
			  
			 //Create a view. Please use `cbView` method instead of view method from laravel.
			 $this->cbView('backend.barang_upload.index',$data);
		  }
